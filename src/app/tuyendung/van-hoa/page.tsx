...
import {
    Heart, Zap, Users, Target, Quote, Globe, Star, Lightbulb, CheckCircle2
} from 'lucide-react';
...
export default function CulturePage() {
    ...
    return (
        <main className="min-h-screen bg-white font-sans text-slate-800">
            ...
            {/* --- CORE VALUES (DESIGN MỚI: MODERN CARDS) --- */}
            <section className="py-24 bg-gray-50 relative">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="text-center mb-16">
                        <span className="text-[#cc0022] font-bold text-sm uppercase tracking-wider">DNA Của Chúng Tôi</span>
                        <h2 className="text-3xl md:text-5xl font-extrabold text-[#00008b] mt-3">5 Giá Trị Cốt Lõi</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {CORE_VALUES.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Watermark Number (Số chìm khổng lồ) */}
                                    <div className={`absolute -right-4 -bottom-10 text-[10rem] font-black leading-none opacity-[0.03] select-none transition-transform duration-500 group-hover:scale-110 group-hover:opacity-[0.06] ${isBlue ? 'text-[#00008b]' : 'text-[#cc0022]'}`}>
                                        {item.num}
                                    </div>
                                    ...
                                    ${isBlue ? 'bg-gradient-to-br from-blue-900 to-blue-600' : 'bg-gradient-to-br from-red-600 to-orange-500'}`}
                                        ...
                                        <h3 className={`text-xl font-bold uppercase leading-tight ${isBlue ? 'text-[#00008b]' : 'text-[#cc0022]'}`}>
                                            {item.title}
                                        </h3>
                                    </div>

                                    {/* Desc */}
                                    <p className="text-gray-600 leading-relaxed text-justify relative z-10 flex-1">
                                        {item.desc}
                                    </p>
                        ...
                        {/* Card Tổng kết (Optional - lấp đầy ô trống nếu lẻ) */}
                        <div className="bg-[#00008b] rounded-3xl p-8 text-white flex flex-col justify-center items-center text-center shadow-xl relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-xl font-bold uppercase mb-2">Cam Kết Của ERG</h3>
                                <p className="text-blue-100 text-sm">Luôn đồng hành cùng sự phát triển của Giáo dục Việt Nam.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="relative rounded-3xl overflow-hidden bg-[#00008b] text-white shadow-2xl">
                        ...
                        <div className="flex flex-col md:flex-row items-center">
                            {/* Cột trái: Nội dung Quote */}
                            <div className="w-full md:w-3/5 p-10 md:p-16 relative z-10">
                                <Quote size={60} className="text-[#cc0022] mb-6 opacity-80" />
                                <h3 className="text-2xl md:text-3xl font-serif italic leading-relaxed mb-8 opacity-95">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-blue-200 text-sm">Giám đốc - EDURISE GLOBAL CO., LTD</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="w-full md:w-2/5 h-64 md:h-full min-h-[400px] relative">
                                <img
                                    ...
                                    className="absolute inset-0 w-full h-full object-cover opacity-80 mix-blend-overlay md:mix-blend-normal"
                                />
            ...
            <section className="py-24 container mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#00008b]">Nhịp sống Edurise</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-4 h-auto md:h-[600px]">
                    {/* ... Giữ nguyên phần ảnh Bento Grid từ code trước ... */}
                    <div className="md:col-span-2 md:row-span-2 rounded-2xl overflow-hidden relative group shadow-lg cursor-pointer">
                        ...
                        <div className="absolute bottom-6 left-6 text-white z-10"><h3 className="text-xl font-bold drop-shadow-md">Giờ học STEM đầy cảm hứng</h3></div>
                    ...
                    <div className="md:col-span-1 md:row-span-1 rounded-2xl overflow-hidden relative group shadow-lg cursor-pointer">
                        ...
                        <div className="absolute bottom-4 left-4 text-white z-10"><h3 className="font-bold text-sm drop-shadow-md">Đào tạo Giáo viên</h3></div>
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    </div>
                    <div className="md:col-span-1 md:row-span-1 rounded-2xl overflow-hidden relative group shadow-lg cursor-pointer">
                        ...
                        <div className="absolute bottom-4 left-4 text-white z-10"><h3 className="font-bold text-sm drop-shadow-md">Team Building</h3></div>
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    </div>
                    <div className="md:col-span-2 md:row-span-1 rounded-2xl overflow-hidden relative group shadow-lg cursor-pointer">
                        ...
                        <div className="absolute bottom-4 left-4 text-white z-10"><h3 className="font-bold text-lg drop-shadow-md">Hội thảo Công nghệ Giáo dục</h3></div>
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    </div>
                </div>
            </section>
