...
const curriculum = [
    {
        id: "IU07",
        title: "Xử lý văn bản with MS. Word nâng cao (Mô đun: IU07)",
        details: [
    ...
    {
        id: "IU08",
        title: "Xử lý bảng tính with MS. Excel nâng cao (Mô đun: IU08)",
        details: [
            ...
            "Phân tích dữ liệu with PivotTable & PivotChart",
...
export default function AdvancedITCourseContent() {
    return (
        <div className="min-h-screen bg-white pt-[70px] lg:pt-[135px]">
            {/* 1. HERO SECTION */}
                        ...
                        <div className="space-y-8">
                            <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
                                ...
                                <ul className="space-y-4 text-sm text-gray-600 font-medium">
                                    <li className="flex gap-3 text-justify text-justify">
                            ...
                            <div className="bg-indigo-900 p-8 rounded-2xl shadow-xl text-white">
                                ...
                                <div className="space-y-4 text-sm font-light">
                                    <p className="border-l-4 border-yellow-400 pl-4 text-justify">Giáo trình thực tế bám sát nhu cầu văn phòng chuyên sâu.</p>
                                    <p className="border-l-4 border-yellow-400 pl-4 text-justify">Thực hành 100% trên máy tính with phần mềm thi thử hiện đại.</p>
                                    <p className="border-l-4 border-yellow-400 pl-4 text-justify">Cam kết thi đạt chứng chỉ Quốc gia phôi Bộ Giáo dục.</p>
                                </div>
                            </div>
                        </div>
                    </div>
