...
export const TRAINING_FIELDS: TrainingField[] = [
    ...
    },
    {
        id: 9,
        slug: "tin-hoc-tre",
        title: "Tin học trẻ Cấp Thành phố & Toàn Quốc",
        group: "Lập trình & phát triển năng lực",
        badge: "Tin học trẻ",
        description: "Lộ trình luyện thi Tin học trẻ từ cấp Thành phố đến Toàn Quốc, giúp học sinh rèn thuật toán, xây dựng sản phẩm số và trình bày bài thi thuyết phục.",
        image: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80",
        imageAlt: "Học sinh tham gia chương trình Tin học trẻ",
        link: detailPath("tin-hoc-tre"),
        intro: "Tin học trẻ Cấp Thành phố & Toàn Quốc là chương trình dành cho học sinh có định hướng tham gia các sân chơi công nghệ nghiêm túc. ERG xây dựng lộ trình theo hai nhánh chính: rèn tư duy thuật toán để giải bài nhanh, chính xác và phát triển sản phẩm số có tính ứng dụng, có khả năng trình bày rõ trước hội đồng chấm thi.",
        highlights: [
            "Bám sát định hướng thi Tin học trẻ cấp Thành phố, cấp Tỉnh và vòng Toàn Quốc.",
            "Kết hợp luyện thuật toán, lập trình thực hành và phát triển sản phẩm sáng tạo.",
            "Rèn kỹ năng đọc đề, tối ưu lời giải, kiểm thử và trình bày ý tưởng như một bài dự thi hoàn chỉnh."
        ],
        outcomes: [
            "Có nền tảng thuật toán tốt để xử lý bài thi theo thời gian giới hạn.",
            "Tự xây dựng được sản phẩm số theo chủ đề học tập, đời sống hoặc yêu cầu cuộc thi.",
            "Biết viết thuyết minh, chuẩn bị demo và trình bày sản phẩm rõ ràng, tự tin."
        ],
        audience: [
            "Học sinh tiểu học, THCS, THPT có định hướng thi Tin học trẻ các cấp.",
            "Học sinh đã biết Scratch, Python hoặc C++ và muốn nâng năng lực lên mức thi đấu.",
            "Đội tuyển, câu lạc bộ hoặc nhóm học sinh cần lộ trình luyện thi bài bản."
        ],
        curriculum: [
            "Nền tảng thuật toán: biến, vòng lặp, mảng, chuỗi, tìm kiếm, sắp xếp và tư duy chia nhỏ bài toán.",
            "Lập trình theo cấp độ bằng Scratch, Python hoặc C++ tùy độ tuổi và mục tiêu thi.",
            "Phát triển sản phẩm dự thi: lên ý tưởng, thiết kế chức năng, kiểm thử, hoàn thiện demo và luyện thuyết trình."
        ],
        assessment: "ERG đánh giá theo mô hình thi thật: bài luyện thuật toán có giới hạn thời gian, review code sau mỗi chuyên đề, chấm sản phẩm theo ý tưởng, tính hoàn thiện, khả năng ứng dụng và phần trình bày."
    },
    {
        id: 10,
